accessid= 'LTAI9XN8UNtrxW9d';
accesskey= 'WDVhmBr4EywOyCIGr9fC3tBrTL3Vmg';
host = 'https://jloss.jianlangcn.com';
...
var uploader = new plupload.Uploader({
	...
	init: {
		PostInit: function() {
			...
			document.getElementById('postfiles').style.zIndex = "-1";
...
// 		},
		...
		FileUploaded: function(up, file, info) {
			...
			var img = '<img class="weui-uploader__input-box" src='+my_url+' />';
			$("#img-content").prepend(img);
